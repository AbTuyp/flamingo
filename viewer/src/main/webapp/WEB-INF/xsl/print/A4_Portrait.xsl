...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:variable name="map-width-px" select="'405'"/>
    <xsl:variable name="map-height-px" select="'680'"/>
    ...
    <xsl:template name="map-block">
            ...
            <fo:block-container margin-top="0.0cm" height="17cm" xsl:use-attribute-sets="column-block">
